...
**⚠️ DEPRECATED:** This file has been superseded by `/API_DOCUMENTATION.md`

**Please use the new consolidated documentation at: `/API_DOCUMENTATION.md`**

This file is kept for historical reference only. All future updates should be made to the new unified documentation.

---

## Migration Notice

As of **December 21, 2025**, all API documentation has been consolidated into a single comprehensive document.

### What Changed

- **Old Location:** `.cursor/rules/api-documentation.md` (this file)
- **New Location:** `/API_DOCUMENTATION.md` (root of project)

### Why the Change

The new documentation provides:
- ✅ Complete coverage of all 22 endpoints
...
- **Migration Summary:** `/API_DOCUMENTATION_MIGRATION_SUMMARY.md`
- **Recent Changes:** `/PRODUCTION_API_MIGRATION.md`

---

## Original Content Below (Archived)

This content is preserved for reference but may be outdated. Please consult `/API_DOCUMENTATION.md` for current information.
