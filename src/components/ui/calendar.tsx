...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white rounded-md border-0 shadow-sm", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-muted-foreground hover:text-foreground hover:bg-muted"
        ),
